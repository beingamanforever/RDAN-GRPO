...
from rdan_grpo.safe_rule import evaluate_rule, function_sha256, mutate_returns, validate_rule
...
def _certificate_from_evidence(path: Path, function_instances: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "evaluator": {
            "path": "src/rdan_grpo/safe_rule.py",
            "sha256": _sha256(Path(__file__).with_name("safe_rule.py")),
        },
